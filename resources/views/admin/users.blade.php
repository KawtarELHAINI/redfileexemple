                                    ...
                                    <tbody class="bg-white divide-y divide-blue-200 " id="users-container">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                                <div><img src="" alt="" class="w-8 h-8 rounded-full"></div>
                                            </td>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">name</td>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">email</td>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                               
                                                    <div class="text-sm text-blue-500 bg-blue-500/20 w-fit px-4 py-1 rounded-2xl">admin</div>
                                              
                                                    <div class="text-sm text-blue-500 bg-blue-400/20 w-fit px-4 py-1 rounded-2xl">organiser</div>
                                                
                                                    <div class="text-sm text-blue-500 bg-blue-400/20 w-fit px-4 py-1 rounded-2xl">Client</div>
                                                
                                            </td>
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">created at</td>
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">updated at</td>
